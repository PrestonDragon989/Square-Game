...
import { mediumBlueAI, basicBlueAI, basicRedAI, complexRedAI, mediumRedAI, complexBlueAI } from "./AI.mjs";
...
class Utils {
    ...
    convertAI(AI, rect, HP, speed, contactDamage, bulletDamage, player, canvas) {
        ...
        else if (AI == "complexBlueAI") return new complexBlueAI(rect, HP, speed, contactDamage, bulletDamage, player, canvas);
    }
    ...
    spawnEnemy(enemyClass, type = "basic") {
        ...
        else if (type == "complex") colors = ["Red", "Blue"];
